...
import com.south.prefee.utils.UriUtils;
...
public class MultiPicChooseBean extends BaseObservable {
    ...
    public static List<MultiPicChooseBean> getAddImageBean() {
        ...
        MultiPicChooseBean choosePojo = new MultiPicChooseBean(UriUtils.getUriFromResource(R.drawable.ic_photo_camera_black_24dp), 0, "添加图片");
