package com.south.prefee.widget.mvvm.viewmodel;
...
import com.south.prefee.widget.mvvm.DisposableLifeCycleListener;
import com.south.prefee.widget.mvvm.UILifeCycle;
import com.south.prefee.widget.mvvm.factory.ModelFactoryImpl;
import com.south.prefee.widget.mvvm.model.BaseModel;
import com.south.prefee.widget.mvvm.proxy.BaseViewModelProxyMethod;
import com.south.prefee.widget.mvvm.proxy.ViewModelDisposableProxy;
...
public class BaseViewModel<V extends BaseMVVMView, D extends ViewDataBinding, M extends BaseModel> implements BaseViewModelProxyMethod<V>, UILifeCycle<V, D>, DisposableLifeCycleListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
     //   mModel = TUtil.getT(this, 2);
        ModelFactoryImpl<M> modelFactory = ModelFactoryImpl.<M>createModelFactory(getClass());
        mModel = modelFactory.createModel();
